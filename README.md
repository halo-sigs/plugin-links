...
- 友链申请：支持访客通过主题表单或 REST API 提交申请，并提供图形验证码、待审核容量限制、管理员通知、申请审核和批量清理。
- AI 辅助：可通过 AI Foundation 从新评论中自动识别友链申请，也可在添加链接时从最新评论中提取站点信息。
...
- 订阅阅读：在 Console 中查看全部或单个链接的订阅动态，支持未读筛选、全部标为已读、收藏、稍后阅读，以及隐藏和恢复订阅条目。
