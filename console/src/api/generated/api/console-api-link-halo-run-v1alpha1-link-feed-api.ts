...
export const ConsoleApiLinkHaloRunV1alpha1LinkFeedApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Return exact global counts for hidden, visible favorite, and visible read-later cached RSS or Atom feed items.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getLinkFeedItemSummary: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/apis/console.api.link.halo.run/v1alpha1/rss/items/-/summary`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        getLinkFeedUnreadSummary: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/apis/console.api.link.halo.run/v1alpha1/rss/items/-/unread-summary`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const ConsoleApiLinkHaloRunV1alpha1LinkFeedApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getLinkFeedItemSummary(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LinkFeedItemSummary>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getLinkFeedItemSummary(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ConsoleApiLinkHaloRunV1alpha1LinkFeedApi.getLinkFeedItemSummary']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Summarize unread cached RSS or Atom feed item counts.
         ...
         * @throws {RequiredError}
         */
        async getLinkFeedUnreadSummary(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LinkFeedUnreadSummary>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getLinkFeedUnreadSummary(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ConsoleApiLinkHaloRunV1alpha1LinkFeedApi.getLinkFeedUnreadSummary']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * List cached RSS or Atom feed items with cursor pagination.
...
export const ConsoleApiLinkHaloRunV1alpha1LinkFeedApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getLinkFeedItemSummary(options?: RawAxiosRequestConfig): AxiosPromise<LinkFeedItemSummary> {
            return localVarFp.getLinkFeedItemSummary(options).then((request) => request(axios, basePath));
        },
        /**
         * Summarize unread cached RSS or Atom feed item counts.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getLinkFeedUnreadSummary(options?: RawAxiosRequestConfig): AxiosPromise<LinkFeedUnreadSummary> {
            return localVarFp.getLinkFeedUnreadSummary(options).then((request) => request(axios, basePath));
        },
        /**
         * List cached RSS or Atom feed items with cursor pagination.
...
export class ConsoleApiLinkHaloRunV1alpha1LinkFeedApi extends BaseAPI {
     ...
     * @memberof ConsoleApiLinkHaloRunV1alpha1LinkFeedApi
     */
    public getLinkFeedItemSummary(options?: RawAxiosRequestConfig) {
        return ConsoleApiLinkHaloRunV1alpha1LinkFeedApiFp(this.configuration).getLinkFeedItemSummary(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ConsoleApiLinkHaloRunV1alpha1LinkFeedApi
     */
    public getLinkFeedUnreadSummary(options?: RawAxiosRequestConfig) {
        return ConsoleApiLinkHaloRunV1alpha1LinkFeedApiFp(this.configuration).getLinkFeedUnreadSummary(options).then((request) => request(this.axios, this.basePath));
    }
