...
export const LinkV1alpha1ApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createLink: async (link?: Link, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        deleteLink: async (name: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getLink: async (name: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        listLink: async (page?: number, size?: number, labelSelector?: Array<string>, fieldSelector?: Array<string>, sort?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/apis/core.halo.run/v1alpha1/links`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        patchLink: async (name: string, jsonPatchInner?: Set<JsonPatchInner>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateLink: async (name: string, link?: Link, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
...
export const LinkV1alpha1ApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createLink(link?: Link, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Link>> {
         ...
         * @throws {RequiredError}
         */
        async deleteLink(name: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getLink(name: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Link>> {
         ...
         * @throws {RequiredError}
         */
        async listLink(page?: number, size?: number, labelSelector?: Array<string>, fieldSelector?: Array<string>, sort?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<LinkList>> {
         ...
         * @throws {RequiredError}
         */
        async patchLink(name: string, jsonPatchInner?: Set<JsonPatchInner>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Link>> {
         ...
         * @throws {RequiredError}
         */
        async updateLink(name: string, link?: Link, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Link>> {
...
export const LinkV1alpha1ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createLink(requestParameters: LinkV1alpha1ApiCreateLinkRequest = {}, options?: AxiosRequestConfig): AxiosPromise<Link> {
         ...
         * @throws {RequiredError}
         */
        deleteLink(requestParameters: LinkV1alpha1ApiDeleteLinkRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        getLink(requestParameters: LinkV1alpha1ApiGetLinkRequest, options?: AxiosRequestConfig): AxiosPromise<Link> {
         ...
         * @throws {RequiredError}
         */
        listLink(requestParameters: LinkV1alpha1ApiListLinkRequest = {}, options?: AxiosRequestConfig): AxiosPromise<LinkList> {
         ...
         * @throws {RequiredError}
         */
        patchLink(requestParameters: LinkV1alpha1ApiPatchLinkRequest, options?: AxiosRequestConfig): AxiosPromise<Link> {
         ...
         * @throws {RequiredError}
         */
        updateLink(requestParameters: LinkV1alpha1ApiUpdateLinkRequest, options?: AxiosRequestConfig): AxiosPromise<Link> {
...
export class LinkV1alpha1Api extends BaseAPI {
     ...
     */
    public createLink(requestParameters: LinkV1alpha1ApiCreateLinkRequest = {}, options?: AxiosRequestConfig) {
     ...
     * @memberof LinkV1alpha1Api
     */
    public deleteLink(requestParameters: LinkV1alpha1ApiDeleteLinkRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof LinkV1alpha1Api
     */
    public getLink(requestParameters: LinkV1alpha1ApiGetLinkRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof LinkV1alpha1Api
     */
    public listLink(requestParameters: LinkV1alpha1ApiListLinkRequest = {}, options?: AxiosRequestConfig) {
     ...
     * @memberof LinkV1alpha1Api
     */
    public patchLink(requestParameters: LinkV1alpha1ApiPatchLinkRequest, options?: AxiosRequestConfig) {
     ...
     * @memberof LinkV1alpha1Api
     */
    public updateLink(requestParameters: LinkV1alpha1ApiUpdateLinkRequest, options?: AxiosRequestConfig) {
