# link-application-rest-api Specification

## Purpose
Define the cookie-free public REST contract for issuing visitor CAPTCHA challenges and creating
friend-link applications from browser and general HTTP clients.
